        ...
        with open(savepath+hrtf_filename, 'w') as csvfile:
            ...
            for spec in range(len(spec_name_list)):
                writer.writerow([spec_name_list[spec],
                                 n_runs_list[spec],
                                 "{0:.3f}".format(test_mean_per_spec[spec]*100),
                                 "{0:.3f}".format(test_standard_error[spec]*100),
                                 "{0:.3f}".format(test_std_per_spec[spec]*100),
                                 "{0:.3f}".format(test_var_per_spec[spec]*100),
                                 "{0:.3f}".format(test_median_per_spec[spec]*100),
                                 "{0:.3f}".format(test_max_per_spec[spec]*100),
                                 "{0:.3f}".format(test_min_per_spec[spec]*100),
                                 "{0:.3f}".format(v_mean_per_spec[spec]*100),
                                 "{0:.3f}".format(v_standard_error[spec]*100),
                                 "{0:.3f}".format(v_std_per_spec[spec]*100),
                                 "{0:.3f}".format(v_var_per_spec[spec]*100),
                                 "{0:.3f}".format(v_median_per_spec[spec]*100),
                                 "{0:.3f}".format(v_max_per_spec[spec]*100),
                                 "{0:.3f}".format(v_min_per_spec[spec]*100),
                                 "{0:.3f}".format(t_mean_per_spec[spec]*100),
                                 "{0:.3f}".format(t_standard_error[spec]*100),
                                 "{0:.3f}".format(t_std_per_spec[spec]*100),
                                 "{0:.3f}".format(t_var_per_spec[spec]*100),
                                 "{0:.3f}".format(t_median_per_spec[spec]*100),
                                 "{0:.3f}".format(t_max_per_spec[spec]*100),
                                 "{0:.3f}".format(t_min_per_spec[spec]*100),
